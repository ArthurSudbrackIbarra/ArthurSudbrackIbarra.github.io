      ...
      <div class="box">
        <div class="content">     
          ...
          <custom-button-component
            ...
            to = "github"
            href = "https://github.com/ArthurSudbrackIbarra/MagCounters-Site"
          ></custom-button-component>
          <custom-button-component
            text="Go to Site"
            to="default"
            href="http://www.magcounters.com"
          ></custom-button-component>
          ...
          <p>
            <a href="https://drive.google.com/uc?export=view&id=1eY_eKwbHqc_j5eitYUZr8qikO16zMgTp" target="_blank">
                <img src="https://drive.google.com/uc?export=view&id=1eY_eKwbHqc_j5eitYUZr8qikO16zMgTp" title="Click to enlarge gif"/>
            </a>
          </p>
          ...
          ></custom-button-component>
          <custom-button-component
            text="Invite Bot To Your Server"
            to="discord"
            href="https://discord.com/api/oauth2/authorize?client_id=808576823569940492&permissions=2148006976&scope=bot"
          ></custom-button-component>
          ...
          <p>
            ...
            <img src="https://drive.google.com/uc?export=view&id=1n1wHTIM-uqzAHfJQvpFPQwtiJRdEQowg" title="Click to enlarge gif"/>
          </p>
        </div>     
      </div>
    `;
