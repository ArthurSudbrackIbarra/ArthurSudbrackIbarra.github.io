    ...
    this.innerHTML = `
      <div class="box">
        <div class="content">     
          ...
          <custom-button-component text = "Go to Repository" to = "github" href = "https://github.com/ArthurSudbrackIbarra/AutoZoom"></custom-button-component>
          ...
          <h3 id="demonstration-1">Demonstration 1:</h3>
          <img src="../assets/autozoom.png">        
          <h3 id="demonstration-2">Demonstration 2:</h3>
          ...
          <a href="https://drive.google.com/uc?export=view&id=1n1wHTIM-uqzAHfJQvpFPQwtiJRdEQowg" target="_blank">           
            <img id="demo-image-1" class="loading-image" src="https://drive.google.com/uc?export=view&id=1KSD7VZAEulobSzMNu4YHn2ga1FslakmM" title="Click to enlarge gif"/>
          </a>   
        </div>
      </div>
    `;
